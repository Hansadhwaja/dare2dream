    ...
    >
      <div className="rounded-[2rem] bg-secondary/80 px-7 py-12 sm:px-12 lg:flex lg:items-end lg:justify-between lg:px-16 lg:py-14">
        <div>
          ...
          <h2 className="mt-4 max-w-2xl font-heading text-5xl leading-[0.95] font-semibold tracking-[-0.015em] sm:text-6xl">
        ...
        <Link
          href="/contact"
          className="mt-8 inline-flex items-center gap-2 rounded-full bg-primary px-7 py-4 font-sans text-sm font-semibold text-primary-foreground lg:mt-0"
        >
          Become a member
